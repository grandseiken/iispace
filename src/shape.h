...
public:
  ...
  flvec2 convert_fl_point(const flvec2& position, float rotation, const flvec2& v) const;
...
public:
  ...
  void render(Lib& lib, const flvec2& position, float rot, colour_t colour = 0) const override;
