...
inline glm::vec2
render_aspect_scale(const glm::uvec2& screen_dimensions, const glm::uvec2& render_dimensions) {
...
inline float
render_scale(const glm::uvec2& screen_dimensions, const glm::uvec2& render_dimensions) {
