...
struct PlayerShot : ecs::component {
  ...
  using shape = standard_transform<geom::box_colour_p<vec2{2 + 1_fx / 2_fx, 2 + 1_fx / 2_fx}, 2>,
                                   geom::box_colour_p<vec2{1 + 1_fx / 4_fx, 1 + 1_fx / 4_fx}, 3>,
                                   geom::box_colour_p<vec2{3 + 3_fx / 4_fx, 3 + 3_fx / 4_fx}, 3>>;
