#ifndef II_GAME_LOGIC_LEGACY_ENEMY_ENEMY_H
#define II_GAME_LOGIC_LEGACY_ENEMY_ENEMY_H
...
void spawn_square(SimInterface&, const vec2& position, fixed rotation = pi<fixed> / 2);
