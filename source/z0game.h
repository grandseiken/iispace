...
private:
    ...
    bool IsHardModeUnlocked() const
    {
        return IsBossModeUnlocked() &&
            ( _highScores[ Lib::PLAYERS ][ 0 ].second > 0 || _highScores[ Lib::PLAYERS ][ 1 ].second > 0 || _highScores[ Lib::PLAYERS ][ 2 ].second > 0 || _highScores[ Lib::PLAYERS ][ 3 ].second > 0 );
    }
    ...
    void NewGame( bool canFaceSecretBoss, bool bossMode = false, bool replay = false, bool hardMode = false, bool fastMode = false, bool whatMode = false );
    void EndGame();
